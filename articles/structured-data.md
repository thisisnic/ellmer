...
[`parallel_chat_structured()`](https://ellmer.tidyverse.org/reference/parallel_chat.md).
...
([`vignette("tool-calling")`](https://ellmer.tidyverse.org/articles/tool-calling.md)),
...
- **Scalars** represent single values. These are
  ...
  [`type_integer()`](https://ellmer.tidyverse.org/reference/type_boolean.md),
  [`type_number()`](https://ellmer.tidyverse.org/reference/type_boolean.md),
  [`type_string()`](https://ellmer.tidyverse.org/reference/type_boolean.md),
  and
  [`type_enum()`](https://ellmer.tidyverse.org/reference/type_boolean.md),
...
- **Arrays** represent a vector of values of the same type. They are
  created with
  [`type_array()`](https://ellmer.tidyverse.org/reference/type_boolean.md)
...
- **Objects** represent a collection of named values. They are created
  with
  [`type_object()`](https://ellmer.tidyverse.org/reference/type_boolean.md).
